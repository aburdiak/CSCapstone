...
urlpatterns = [
    ...
    url(r'^university/coursepage$', views.coursepage, name='CoursePage'),
    url(r'^university/course/form$', views.courseForm, name="CourseForm"),
    url(r'^university/course/student_added$', views.addStudent, name="AddStudent"),
    url(r'^university/course/addcourse$', views.addCourse, name="AddCourse"),
